...
def parse_args():
    ...
    parser.add_argument(
        "--model_path", nargs="?", default="model/best_fm.ckpt", help="path for pretrain model",
    )
    ...
    parser.add_argument('--alpha1', type=float, default=1e-2, help='intent contrastive loss weight')
    parser.add_argument('--alpha2', type=float, default=1e-2, help='cross-view contrastive loss weight')
